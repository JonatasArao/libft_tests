...
/*   Updated: 2024/10/22 17:10:22 by jarao-de         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
MU_TEST(test_ft_strjoin_s1_null)
{
	...
	// ACT & ASSERT
	actual_result = 1;
	expected_result = capture_segfault_ft_strjoin(&ft_strjoin, NULL, "42");
...
MU_TEST(test_ft_strjoin_s2_null)
{
	...
	// ACT & ASSERT
	actual_result = 1;
	expected_result = capture_segfault_ft_strjoin(&ft_strjoin, "42", NULL);
	mu_assert(expected_result == actual_result, "Expected segmentation fault, but it did not occur.");
}
...
MU_TEST(test_ft_strjoin_s1_null_s2_null)
{
	...
	// ACT & ASSERT
	actual_result = 1;
	expected_result = capture_segfault_ft_strjoin(&ft_strjoin, NULL, NULL);
	mu_assert(expected_result == actual_result, "Expected segmentation fault, but it did not occur.");
}
